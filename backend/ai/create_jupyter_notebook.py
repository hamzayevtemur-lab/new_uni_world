"""
backend/ai/create_jupyter_notebook.py
=====================================
Builds the comprehensive, runnable Jupyter Notebook 'AI_Models_Engineering_Guide.ipynb'
covering both AI modules in detail.
"""
...
def create_notebook():
    ...
    nb_path = os.path.abspath(os.path.join(
        os.path.dirname(__file__), "..", "..", "AI_Models_Engineering_Guide.ipynb"
    ))
